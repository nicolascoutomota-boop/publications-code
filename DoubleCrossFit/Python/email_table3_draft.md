# Email to Shaun with Table 3 ATTACHED (pdf + csv)

Attach: table3_reproduction.pdf and table3_reproduction.csv
...
The reproduced Table 3 is attached, as a PDF and as a CSV in case you want to compute with
